  ...
  return (
    <>
      ...
      <main className="relative flex min-h-screen flex-col items-center justify-center p-4 sm:p-6 md:p-8 overflow-hidden">
        <div className="z-10 flex flex-col items-center w-full max-w-7xl mx-auto space-y-12">
          ...
          <div className="w-full max-w-2xl p-4 sm:p-6 rounded-2xl bg-card/50 backdrop-blur-md border border-white/10 shadow-2xl animate-fade-in-up" style={{animationDelay: '0.3s', animationFillMode: 'backwards'}}>
